...
Announcement: All customers are migrating to webhooks 2.0 in 2023. For details, see [http://www.adobe.com/go/acrobatsigndevrnotes](https://developer-stage.adobe.com/acrobat-sign/docs/overview/releasenotes/).
...
Webhooks regularly evolve with major releases. It’s a good idea to track updates by date from the [Developer Release Notes](https://developer-stage.adobe.com/acrobat-sign/docs/overview/releasenotes/)
