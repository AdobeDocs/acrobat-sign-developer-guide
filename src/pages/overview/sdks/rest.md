...
`Before using the samples, you need to obtain either an OAuth access token or an integration key as described at https://developer.adobe.com/acrobat-sign/docs/overview/developer_guide/gstarted`
