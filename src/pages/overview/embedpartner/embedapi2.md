...
| Request Header | [Auth API Headers](https://developer-stage.adobe.com/acrobat-sign/docs/overview/embedpartner/embedapi2#common-account-api-header-attributes) |
