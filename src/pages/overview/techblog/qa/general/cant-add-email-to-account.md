---
title: Why Can't I Add a User to My Adobe Sign Account?
---
...
You will need to [open a case with support](https://helpx.adobe.com/support/sign.html), and they can work with that person directly. In most cases, this will mean they need to change the email address associated with the existing user to one of their own "personal" email addresses (yahoo, google, outlook.com, etc.). Once this is done, the admin of the corporate/business-related account will be able to add them as "net new" in that account.
